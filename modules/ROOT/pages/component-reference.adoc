...
javadoc:org.apache.tapestry5.corelib.components.Recursive[]::
Loop-like component that renders its body recursively over parent/child data such as trees or nested menus.
The point at which the children are rendered is marked with javadoc:org.apache.tapestry5.corelib.components.RecursiveBody[].
Since 5.9.
