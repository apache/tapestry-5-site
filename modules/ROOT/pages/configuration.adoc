...
NOTE: The descriptor above targets Jakarta EE 9, which is what Tapestry 5.9 is built on.
If you are using the javax build, keep the `javaee` namespace (or the older DTD) and a `version` of 3.1 or below.
See xref:jakarta-ee-migration.adoc[] for the difference between the two builds.
