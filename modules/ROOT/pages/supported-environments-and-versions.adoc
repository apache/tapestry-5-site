...
[%autowidth]
|===
|Tapestry |5.9 | 5.8.4+ | 5.8.1 - 5.8-3 |5.7 |5.6 |5.5 |5.4 |5.3.8 |5.3.0 - 5.3.7 |5.0 - 5.2

|Java JRE
|11-21 footnote:java59[Tapestry 5.9 is still compiled to Java 8 bytecode, but Java 11 is the practical minimum because of the Jakarta EE 9 stack it depends on. The project's CI matrix covers Java 11 and 17. `tapestry-spring` depends on Spring 6 and therefore requires Java 17.]
|8-21
|8-17
|8-14
|8-14
...
|Servlet API
|Jakarta Servlet 5.0 footnote:jakarta59[Tapestry 5.9 ships in two flavours: the Jakarta one (artifacts suffixed with `-jakarta`) targets Jakarta Servlet 5.0, and the javax one (unsuffixed artifacts) keeps targeting `javax.servlet` 3.0+. See the xref:userguide::jakarta-ee-migration.adoc[Jakarta EE migration guide].]
|3.0+
|3.0+
|3.0+
|3.0+
...
[%autowidth]
|===
|Tapestry |5.9 (Jakarta) |5.9 (javax) |5.5+ |5.4 |5.3.8 |5.3.0 - 5.3.7 |5.2 |5.1 | 5.0.10 |5.0.8|5.0
...
[%autowidth]
|===
|Tapestry |5.9 |5.7.3+ |5.5+ |5.4.1 |5.4 |5.3.8 |5.3.7 | 5.3.3-5.3.6 |5.3.2|5.3 - 5.3.1 |5.2.1 - 5.2.0 |5.1 |5.0.16 |5.0.10 |5.0.8 |5.0
